...
# ALTER TABLE starfire."push_tokens_by_userId" ADD "appKey" text;
# ALTER TABLE starfire."push_tokens_by_userId" ADD "deviceId" text;
# ALTER TABLE starfire."push_tokens_by_token" ADD "appKey" text;
# ALTER TABLE starfire."push_tokens_by_token" ADD "deviceId" text;
