...
PREFIXES =
  ...
  THREAD_COMMENTS: 'thread:comments16'
  ...
  ADDON_GET_ALL_BY_GAME_KEY: 'addon:get_all0'
  ...
  THREAD_COMMENTS_THREAD_ID: 'thread_comments:thread_id16'
  ...
  USER_PLAYER_USER_ID_GAME_KEY: 'user_player:user_id_game_id0'
